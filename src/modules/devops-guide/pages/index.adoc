...
If you'd rather not manage Docker Compose files yourself, {PRODUCT_NAME} also has an official one-click template on https://easypanel.io[Easypanel], a self-hosted Docker deployment platform: https://easypanel.io/templates/corteza
